...
import ModalRemovePost from "../modal/remove-post";
...
export default function PostItem() {
  ...
  return (
    <>
      <ModalRemovePost onOpen={onOpen} isOpen={isOpen} onOpenChange={onOnpenChange} id_post="124" />
      <div className="border-b border-b-dark-gray-1 pb-6 hover:bg-dark-header p-4 rounded-lg transtion-all duration-300">
